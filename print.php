...
Print and present this as your E-Ticket in Bus Counter<br><br>
...
while($row = mysqli_fetch_array($result))
	{
		...
		echo 'Total Bill to Pay: '.$row['payable'].'<br>';
	}
...
<br>
<button><a href="javascript:Clickheretoprint()">Print</a></button>